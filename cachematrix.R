...
# Create a cache of the matrix to be inversed as well as
# the result of matrix inversion. 
...
cacheSolve <- function(x, ...) {
    ...
    m <- x$get()  # get the matrix to be inversed
